...
export const ENT_STEP_TABLES = {
  vestibular: {
    ...
    rows: [
      ...
      { key: 'exam', label: 'การตรวจร่างกาย', desc: ['ผลการตรวจร่างกายปกติ', 'ปกติ หรือมีการเดินผิดปกติเพียงเล็กน้อย (เช่น การทดสอบ Romberg)', 'เดินเซ และการทดสอบ Romberg ผิดปกติ', 'เดินได้ด้วยความยากลำบากมากหากไม่มีผู้ช่วย', 'ไม่สามารถยืนหรือเดินได้หากไม่มีผู้ช่วย'] },
      { key: 'objective', label: 'การตรวจวินิจฉัย', desc: ['ผลการตรวจปกติ', 'ผลตรวจการทรงตัว (ENG/VNG หรือ caloric test) ผิดปกติ เช่น พบ positional nystagmus', 'ร่วมกับอาการแสดงทางระบบประสาทส่วนกลาง', 'ร่วมกับผลตรวจ dynamic posturography ผิดปกติ', 'ร่วมกับผลตรวจภาพสมองด้วยคลื่นแม่เหล็กไฟฟ้า (brain MRI) ผิดปกติ'] },
    ],
  },
  facial: {
    ref: '7-5', titleTh: 'ใบหน้า / รูปลักษณ์ (Facial)', classValues: FACE_VALUES,
    note: 'ความผิดปกติเฉพาะบริเวณเหนือคิ้ว คิดไม่เกินร้อยละ 1 ความผิดปกติเฉพาะบริเวณต่ำกว่าริมฝีปากบน คิดไม่เกินร้อยละ 8 และความผิดปกติเต็มใบหน้า (ตั้งแต่คิ้วถึงริมฝีปากบน) คิดร้อยละ 25–45 ส่วนการสูญเสียการมองเห็น การเคลื่อนไหว การหายใจ หรือการรับประทานอาหาร ให้ประเมินในระบบของตนเองแล้วนำมารวมด้วยตารางค่ารวม (Combined Values)',
    rows: [
      { key: 'history', label: 'ประวัติ (ปัจจัยหลัก)', isKey: true, desc: [
        'ไม่มีความผิดปกติ',
      ...
      { key: 'exam', label: 'การตรวจร่างกาย', desc: ['ผลการตรวจร่างกายปกติ', 'มีแผลเป็นที่เห็นได้เล็กน้อย', 'กล้ามเนื้อใบหน้าอ่อนแรงข้างเดียว หรือโครงสร้างจมูกหรือแก้มยุบเล็กน้อย', 'โครงสร้างยุบชัดเจน หรือกล้ามเนื้ออ่อนแรงชัดเจน', 'สูญเสียโครงสร้างอย่างรุนแรง'] },
      { key: 'objective', label: 'การตรวจวินิจฉัย', desc: ['ภาพถ่ายรังสีกระดูกและกระดูกอ่อนปกติ', 'ผิดปกติเล็กน้อย', 'ผิดปกติปานกลาง', 'ผิดปกติสอดคล้องกับประวัติ (ขั้นที่ 3–4)', 'ผิดปกติรุนแรง'] },
    ],
  },
  airway: {
    ...
    note: 'ทางเดินหายใจส่วนล่างและปอด รวมถึงภาวะหยุดหายใจขณะหลับ ให้ประเมินในบทระบบหายใจ ส่วนผู้ที่เจาะคอหรือมีช่องถาวรที่คอ (stoma) เพื่อใช้หายใจ คิดเป็นร้อยละ 25 ของทั้งร่างกาย',
    rows: [
      { key: 'history', label: 'ประวัติอาการเหนื่อย (ปัจจัยหลัก)', isKey: true, desc: [
        'ไม่มีอาการเหนื่อย',
        'ไม่เหนื่อยขณะพัก รบกวนกิจวัตรประจำวันเพียงเล็กน้อยหรือไม่รบกวน',
        'เหนื่อยเฉพาะเมื่อออกแรงหนักหรือเป็นเวลานาน หรือเมื่อขึ้นที่ชัน',
        'เหนื่อยเมื่อเดินบนทางราบตั้งแต่ 50 เมตร หรือขึ้นบันได และต้องหยุดพัก',
        'เหนื่อยขณะพัก (ไม่ตลอดเวลา) โดยเกิดจากกิจวัตรปกติ เช่น อาบน้ำ แต่งตัว หรือหวีผม',
      ] },
      { key: 'exam', label: 'การตรวจร่างกาย', desc: ['ผลการตรวจร่างกายปกติ', 'มีการอุดกั้นหรือเปลี่ยนแปลงเล็กน้อย (minimal)', 'อุดกั้นระดับน้อย (mild)', 'อุดกั้นระดับปานกลาง (moderate)', 'อุดกั้นระดับรุนแรง (severe)'] },
      { key: 'objective', label: 'การตรวจวินิจฉัย (CT ไซนัส / laryngoscopy)', desc: ['ผลการตรวจปกติ', 'ผิดปกติเล็กน้อย', 'ผิดปกติระดับน้อย', 'ผิดปกติระดับปานกลาง', 'ผิดปกติระดับรุนแรง เช่น สายเสียงอัมพาตทั้งสองข้าง'] },
    ],
  },
};
