...
export const GROUPS = [
  ...
  {
    id: 'nihl',
    nameTh: 'แปลผลการได้ยิน & วินิจฉัย NIHL',
    desc: 'แปลผลออดิโอแกรมอาชีวอนามัย: ระดับการได้ยิน · Fit for Work · Threshold Shift เทียบ baseline (NIOSH/OSHA) · เกณฑ์ส่งต่อ ENT (AAO-HNS) · ลักษณะประสาทหูเสื่อมจากเสียงดัง (NIHL) — แนวทางฯ พ.ศ. 2558',
    icon: IC.ear,
