...
const IC = {
  ...
  xray: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="3" width="16" height="18" rx="2.5"/><path d="M12 7v10"/><path d="M12 9c-.7.9-2.1 1.2-2.1 2.8 0 1.7.7 2.7-.5 3.7"/><path d="M12 9c.7.9 2.1 1.2 2.1 2.8 0 1.7-.7 2.7.5 3.7"/></svg>',
  ...
  baht: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M10 7.5h3a2 2 0 0 1 0 4h-3zM10 11.5h3.2a2 2 0 0 1 0 4H10zM10 6v11M12.2 6v1.5M12.2 15.5V17"/></svg>',
};
...
export const GROUPS = [
  ...
  },
  {
    ...
    desc: 'คำนวณร้อยละการสูญเสียสมรรถภาพ (WPI) ตามคู่มือการประเมินการสูญเสียสมรรถภาพอย่างถาวรทางกายและจิต ฉบับจัดทำ 4 (สำนักงานกองทุนเงินทดแทน สำนักงานประกันสังคม)',
    icon: IC.pulse,
    path: '/impairment/',
  },
  {
  ...
  {
    id: 'compensation',
    nameTh: 'คำนวณค่าทดแทน (ประมาณการ)',
    desc: 'ประมาณการค่าทดแทนของผู้ประกันตนจากค่าจ้างรายเดือน ตามหลักร้อยละ 70 ของค่าจ้าง (พ.ร.บ.เงินทดแทน ฉบับที่ 2 พ.ศ. 2561) · เป็นค่าคร่าว ๆ ตรวจสอบกับกองทุนเงินทดแทน',
    icon: IC.baht,
    path: '/impairment/compensation/',
    single: true,
  },
  {
    id: 'nihl',
    nameTh: 'วินิจฉัยประสาทหูเสื่อมจากเสียงดัง (NIHL)',
    desc: 'ตรวจลักษณะออดิโอแกรม + ประวัติสัมผัสเสียง ว่าเข้าได้กับโรคประสาทหูเสื่อมจากเสียงดัง (รอยบาก 3–6 kHz · ประสาทรับเสียง · สองข้าง) ตามหลัก ACOEM/Coles — เครื่องมือสนับสนุนการวินิจฉัย',
    icon: IC.ear,
    path: '/impairment/nihl/',
    single: true,
  },
];
